...
Per informazioni sulla migrazione delle macchine virtuali, consultare la documentazione Broadcom: https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vcenter-and-host-management/migrating-virtual-machines-host-management.html["vSphere Migrazione di macchine virtuali"]
...
Per informazioni sulla gestione degli snapshot delle macchine virtuali, consultare la documentazione Broadcom https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-virtual-machine-administration/managing-virtual-machinesvsphere-vm-admin/using-snapshots-to-manage-virtual-machinesvsphere-vm-admin.html["Gestire le macchine virtuali con gli snapshot"].
