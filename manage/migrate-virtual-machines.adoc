...
Per informazioni sulla gestione degli snapshot delle macchine virtuali, consultare la documentazione Broadcom https://techdocs.broadcom.com/["Documentazione Tecnica Broadcom"^].
